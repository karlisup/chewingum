...
module.exports = function (options) {
  ...
  opts.templateEngine = opts.templateEngine || ['twig', 'mustache']
  // supported file & template extensions
  opts.templateExtensions = helpers.returnMultipleFileExtensions(opts.templateEngine)
  opts.fileExtensions = ['.json', '.md', '.js', '.scss'].concat(opts.templateExtensions)
